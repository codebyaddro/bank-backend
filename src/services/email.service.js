...
async function sendTransactionEmail(userEmail, name, amount, toAccount) {
    ...
    const html = `<p>Hello ${name},</p><p>Your transaction of $${amount} to account ${toAccount} was successful.</p><p>Best regards,<br>Bank Backend Team</p>`;
...
async function sendTransactionFailureEmail(userEmail, name, amount, toAccount) {
    ...
    const html = `<p>Hello ${name},</p><p>We regret to inform you that your transaction of $${amount} to account ${toAccount} has failed. Please try again later.</p><p>Best regards,<br>Bank Backend Team</p>`;
